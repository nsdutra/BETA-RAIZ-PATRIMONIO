#!/usr/bin/env python3
# gerar_versoes.py v1.17 (23/09/2026) — ARQ ganha js/fiscal.js (frente fiscal,
# Fase 3 — tela ⚙️ › Empresa › Fiscal, check-up da Reforma Tributária;
# demanda 976fcbf6).
...
# gerar_versoes.py v1.13 (21/09/2026) — ARQ ganha js/resultados.js (Entrega
# A.3 do PLANO_IMPLEMENTACAO_RESULTADOS_MERCADO_FISCAL v2.0.0 — tela nova
# de Resultados, fatia lazy UI-05).
...
# gerar_versoes.py v1.15 (22/09/2026) — ARQ ganha js/raiz-eventos.js (Fase 1
# do wrapper de escrita/evento local — utilitário novo, já com 1 consumidor
